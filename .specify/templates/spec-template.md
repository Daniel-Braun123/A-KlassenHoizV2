...
<!--
  State only requirements applicable to this feature. Each applicable rule MUST be measurable and
  traced to acceptance scenarios or success criteria. Mark a category N/A only with a reason.
-->
...
- **Test evidence**: [Required unit, integration/contract, RLS, E2E, accessibility, and PWA checks]
