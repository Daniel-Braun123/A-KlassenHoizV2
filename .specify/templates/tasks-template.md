...
**Tests**: Tests are REQUIRED wherever the constitution applies. Include unit, integration/contract,
RLS allow-and-deny, end-to-end, accessibility, and PWA tasks in proportion to the feature. A task
list MUST NOT defer security or critical journey coverage to an unspecified later phase.
...
- [ ] T005 [P] Define RLS policies and allow/deny database test harness
- [ ] T006 [P] Implement server-side authentication, authorization, and time authority
- [ ] T007 Create base models/entities that all stories depend on
- [ ] T008 Configure error handling and logging infrastructure
- [ ] T009 Setup environment configuration management
- [ ] T010 [P] Configure TypeScript strict, type checking, linting, and deterministic CI tests
- [ ] T011 [P] Establish accessible mobile-first design-system and PWA test foundations
...
### Tests for User Story 1 (REQUIRED AS APPLICABLE) ⚠️

> **NOTE: Write these tests FIRST, ensure they FAIL before implementation**

- [ ] T012 [P] [US1] Unit test for [domain rule] in tests/unit/test_[name].py
...
- [ ] T015 [P] [US1] RLS allow/deny tests for [data boundary] in [database test path]
- [ ] T016 [P] [US1] End-to-end mobile journey test for [journey] in [e2e test path]
- [ ] T017 [P] [US1] Accessibility and PWA checks for [surface] in [test path]
...
### Tests for User Story 2 (REQUIRED AS APPLICABLE) ⚠️

- [ ] T024 [P] [US2] Unit test for [domain rule] in tests/unit/test_[name].py
...
- [ ] T027 [P] [US2] RLS allow/deny tests for [data boundary] in [database test path]
- [ ] T028 [P] [US2] End-to-end mobile journey test for [journey] in [e2e test path]
- [ ] T029 [P] [US2] Accessibility and PWA checks for [surface] in [test path]
...
### Tests for User Story 3 (REQUIRED AS APPLICABLE) ⚠️

- [ ] T034 [P] [US3] Unit test for [domain rule] in tests/unit/test_[name].py
...
- [ ] T037 [P] [US3] RLS allow/deny tests for [data boundary] in [database test path]
- [ ] T038 [P] [US3] End-to-end mobile journey test for [journey] in [e2e test path]
- [ ] T039 [P] [US3] Accessibility and PWA checks for [surface] in [test path]
...
- Required tests MUST be written and fail for the intended reason before implementation
